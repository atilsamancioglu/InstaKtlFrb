...
class UploadActivity : AppCompatActivity() {
    ...
    internal var selected: Uri? = null
    ...
    fun upload(view: View) {
        ...
        storageReference.putFile(selected!!).addOnSuccessListener { taskSnapshot ->
            ...
            val userComment = customCommentText.text.toString()
        ...
        }.addOnFailureListener { e -> Toast.makeText(applicationContext, e.localizedMessage.toString(), Toast.LENGTH_LONG).show() }
